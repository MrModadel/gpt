...
/**
 * Template Name: Агрегаты на компрессорах RefComp
 *
 * Шаблон страницы "Агрегаты на компрессорах RefComp".
 *
 * @package Termoservis
 */
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <span>Агрегаты на компрессорах RefComp</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Агрегаты на компрессорах RefComp — подбор и сборка под ваш объект</h1>
      <p>Подберём и изготовим холодильные агрегаты на компрессорах RefComp для холодильных камер, складов, пищевых производств и промышленного холода. Учитываем температурный режим, хладагент, условия установки и требования к автоматике. Возможна поставка как отдельного агрегата, так и решения «под ключ».</p>
      <button class="btn" id="openCalcModal">Подобрать агрегат RefComp и рассчитать стоимость</button>
   </div>
</section>
...
<section>
   <div class="container">
       <div class="section-title">
         <h2>Какие задачи решают агрегаты на компрессорах RefComp?</h2>
       </div>
       <div class="problems-grid">
          <div class="problem-card">
            ...
            <h3>Нестабильная температура в камерах</h3>
            <p>Колебания температуры ухудшают качество хранения и ведут к потерям продукции. Правильно подобранный агрегат обеспечивает стабильную работу испарителей и поддержание заданного режима.</p>
          </div>
          <div class="problem-card">
             <div class="problem-icon">
                <i class="fas fa-chart-line"></i>
             </div>
            <h3>Высокие затраты на электроэнергию</h3>
            <p>Энергопотребление холодильного участка напрямую зависит от эффективности компрессорной части и корректного регулирования. Компоновка с RefComp и современной автоматикой помогает снизить расходы на частичных нагрузках.</p>
          </div>
          <div class="problem-card">
             <div class="problem-icon">
                <i class="fas fa-sync-alt"></i>
             </div>
            <h3>Простои из‑за аварий и перегрузок</h3>
            <p>Неправильный подбор по режиму или слабая защита приводят к частым остановкам. Мы рассчитываем параметры, подбираем комплект защиты и настраиваем автоматику для стабильной работы 24/7.</p>
          </div>
          <div class="problem-card">
             <div class="problem-icon">
                <i class="fas fa-tint"></i>
             </div>
            <h3>Сложности монтажа и обслуживания</h3>
            <p>Для объекта важны доступ к сервису, удобство размещения и понятная логика управления. Продумываем компоновку на раме, узлы обслуживания, документацию и варианты удалённого мониторинга.</p>
          </div>
       </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Преимущества агрегатов на компрессорах RefComp</h2>
      </div>
      <p class="section-intro">Агрегаты на базе RefComp подбираются под ваш режим (средне‑/низкотемпературный), тип хладагента и условия эксплуатации. Сборка включает расчёт, компоновку узлов, настройку автоматики и заводские испытания перед отгрузкой.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Подбор под режим и требования объекта</h3>
               <p>Учитываем температуру кипения/конденсации, условия окружающей среды, тип установки (в помещении/на улице), уровень шума и требования к резервированию.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Надёжная компрессорная часть RefComp</h3>
               <p>Стабильная работа в промышленном режиме, аккуратная сборка на раме, виброизоляция и корректная обвязка для снижения рисков утечек и повышенного износа.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Автоматика и комплекс защит</h3>
               <p>Датчики и защиты по давлению/температуре, контроль аварий, логика оттайки и сигнализация. Возможна интеграция в диспетчеризацию и удалённый мониторинг.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Энергоэффективность и регулирование</h3>
               <p>Подбираем управление производительностью под динамику нагрузки: ступенчатое/плавное регулирование, оптимизацию конденсации и режимы экономии.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Компоновка и опции под ваш проект</h3>
               <p>Зимний комплект, шумозащита, ресивер/маслоотделение (по необходимости), фильтрация и сервисные узлы — под требования площадки и нормативы.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Сопровождаем проект от расчёта до пусконаладки: консультации, документация, обучение персонала и сервисное обслуживание.</p>
            </div>
         </div>
      </div>
...
<!-- Секция товаров
 <section class='products-section'>
    <div class="container">
       <div class="section-title">
         <h2>Подберите агрегат на компрессоре RefComp</h2>
       </div>
      <p class="section-intro">Подбор по режиму и параметрам: средне‑/низкотемпературные решения, различная холодопроизводительность, варианты автоматики и исполнения.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для агрегатов RefComp
         $category_slug = 'refcomp-compressor-units';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Агрегаты на компрессорах RefComp — особенности выбора и эксплуатации</h2>

         <p>Компрессорный агрегат — это «сердце» холодильной системы: он обеспечивает циркуляцию хладагента и необходимую холодопроизводительность для испарителей в камерах или технологических теплообменниках. От правильного подбора агрегата зависят стабильность температуры, энергопотребление и надёжность участка.</p>

         <p>Агрегаты на компрессорах RefComp подходят для средне‑ и низкотемпературных режимов. Компоновка может включать узлы обвязки, автоматику и защиты, а также опции под условия эксплуатации — например, зимний комплект или шумозащиту.</p>

         <p>При выборе учитывают требуемую холодопроизводительность (кВт), расчетные температуры кипения/конденсации, тип хладагента, условия окружающей среды, требования к резервированию, а также конфигурацию системы (количество испарителей, оттайка, длины трасс, маслообмен).</p>

         <p>Эксплуатация включает регулярную проверку герметичности, контроль масла и давления, обслуживание фильтров и автоматики, очистку теплообменных поверхностей конденсатора. При необходимости внедряется удалённый мониторинг и журналирование аварий для диагностики.</p>

         <p>Заказывая агрегаты RefComp у производителя «ТермоСервис», вы получаете инженерный подбор под вашу задачу, сборку и испытания, гарантию 2 года, а также услуги по монтажу и сервису. Это помогает снизить риски простоев и оптимизировать энергопотребление.</p>
      </div>
   </div>
</section>
...
<section class="final-cta">
   <div class="container">
      <h2>Нужно подобрать агрегат RefComp под вашу задачу?</h2>
      <p>Свяжитесь с нашими инженерами для бесплатного расчёта и подбора комплектации.</p>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчёт стоимости агрегата на компрессоре RefComp</h3>
      <div class="modal-product-info">
         <h4>Страница: Агрегаты на компрессорах RefComp</h4>
         <p>Подготовим предложение с учётом температурного режима, хладагента, условий установки и требований к автоматике.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет агрегата RefComp">
         ...
         <div class="form-group">
            <label for="calcUnitType">Температурный режим</label>
            <select id="calcUnitType" name="unitType" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="mt">Среднетемпературный</option>
               <option value="lt">Низкотемпературный</option>
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Температура камеры/процесса, объем, продукт, хладагент (если известен), условия установки (улица/цех), требования по шуму, сроки..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: агрегат RefComp">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: агрегат RefComp">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: агрегат RefComp">
         <div class="form-group">
