...
<section class="hero">
   <div class="container">
      <h1>Чиллеры для пресс-форм с точным контролем температуры</h1>
      <p>Промышленные чиллеры для пресс-форм поддерживают стабильную температуру теплоносителя для контуров охлаждения формы и коллекторов. Это снижает брак, ускоряет цикл литья и повышает повторяемость изделий. Подберём решение под вашу пресс-форму, материал и режим производства.</p>
      <button class="btn" id="openCalcModal">Рассчитать стоимость чиллера для пресс-форм</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие проблемы решает чиллер для пресс-форм?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Нестабильная температура пресс-формы</h3>
            <p>Приводит к короблению, усадке, «утяжинам», нестабильным размерам и дефектам поверхности. Стабильное охлаждение снижает процент брака.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-chart-line"></i>
            </div>
            <h3>Скачки температуры и давления воды</h3>
            <p>При охлаждении от водопровода или нестабильного источника параметры меняются в течение дня и сезона. Это увеличивает цикл, повышает брак и усложняет настройку процесса.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-sync-alt"></i>
            </div>
            <h3>Длинный цикл литья</h3>
            <p>Недостаточное охлаждение увеличивает время выдержки и охлаждения изделия. Чиллер позволяет ускорить цикл и повысить производительность смены.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-tint"></i>
            </div>
            <h3>Отложения и нестабильный расход</h3>
            <p>Жёсткая вода и загрязнения засоряют каналы пресс-форм и теплообменники. Закрытый контур с фильтрацией и стабильным расходом снижает риск перегрева.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Особенности чиллеров серии TS-MOLD для пресс-форм</h2>
      </div>
      <p class="section-intro">Чиллеры нашего производства рассчитаны на охлаждение пресс-форм и термостатов, обеспечивая стабильную температуру теплоносителя и высокий расход для тонких каналов. Подходят для многогнездных и горячеканальных форм, а также для круглосуточной эксплуатации в цеху.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               ...
               <p>Стабильная температура пресс-формы повышает повторяемость геометрии изделия и снижает брак на старте и в течение смены.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Насосная группа подбирается под сопротивление контуров пресс-форм и коллекторов, обеспечивая равномерное охлаждение по всем каналам.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Фильтрация и защита контуров</h3>
               <p>Фильтры, датчики протока и защиты по давлению помогают предотвращать засоры, кавитацию и перегрев, продлевая ресурс пресс-форм.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
         ...
         <div class="feature-item">
            ...
            <div class="feature-text">
               ...
               <p>Проектирование контуров, коллекторы, обвязка, монтаж, пусконаладка и обучение персонала для стабильной работы участка литья.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите чиллер для ваших пресс-форм</h2>
      </div>
      <p class="section-intro">Мы предлагаем решения для малых, средних и крупных литьевых производств: от одной пресс-формы до цеха с несколькими линиями и коллекторами.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для пресс-форм
         $category_slug = 'press-forms';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Промышленные чиллеры для пресс-форм — особенности выбора и эксплуатации</h2>

         <p>В литье пластмасс под давлением температура пресс-формы и стабильность охлаждения напрямую влияют на внешний вид, геометрию и повторяемость изделий. Перегрев или колебания температуры приводят к короблению, усадке, «утяжинам», нестабильным размерам и росту процента брака.</p>

         <p>Чиллер для пресс-форм обеспечивает замкнутую циркуляцию воды/гликоля через контуры охлаждения формы, коллекторы и термостаты. Закрытая система даёт стабильный расход и температуру теплоносителя, снижает расход воды и защищает оборудование от загрязнений.</p>

         <p>При выборе чиллера учитывают тепловую нагрузку пресс-формы и изделия, требуемую стабильность температуры, расход и давление в контурах охлаждения, количество независимых линий, а также качество воды и требования к материалам теплообменника. Для литьевого цеха важны фильтрация, датчики протока и защита по давлению.</p>

         <p>Эксплуатация в цеху требует учёта запыленности, температуры окружающего воздуха, стабильности электросети и регулярного обслуживания водяного контура. Современные чиллеры оснащаются защитами от перегрузок, аварийными сигналами, самодиагностикой, а при необходимости — зимним комплектом и защитой от замерзания.</p>

         <p>Заказывая чиллер для пресс-форм у производителя «ТермоСервис», вы получаете инженерный расчёт под конкретные формы и режимы литья, подбор насосной группы и автоматики, заводские испытания, гарантию 2 года и комплексные услуги по монтажу и сервису. Это помогает стабилизировать качество продукции и сократить время цикла.</p>
      </div>
   </div>
</section>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости чиллера для пресс-форм</h3>
      <div class="modal-product-info">
         <h4>Страница: Чиллеры для пресс-форм</h4>
         <p>Подготовим индивидуальное предложение с учётом числа контуров, требуемой температуры и режима работы.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет чиллера для пресс-форм">
         ...
         <div class="form-group">
            <label for="calcMoldType">Тип пресс-формы</label>
            <select id="calcMoldType" name="moldType" class="form-control">
               <option value="">Выберите тип</option>
               <option value="cold-runner">Холодноканальная</option>
               <option value="hot-runner">Горячеканальная</option>
               <option value="multi-cavity">Многогнездная</option>
               <option value="large">Крупногабаритная</option>
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Тип пресс-формы, материал изделия, количество контуров, требуемая температура, расход/давление (если известно)..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: чиллер для пресс-форм">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: чиллер для пресс-форм">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: чиллер для пресс-форм">
         <div class="form-group">
