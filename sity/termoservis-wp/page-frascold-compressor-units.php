...
/**
 * Template Name: Агрегаты на компрессорах Frascold
 *
 * Шаблон страницы "Агрегаты на компрессорах Frascold".
 *
 * @package Termoservis
 */
...
<section class="hero">
   <div class="container">
      <h1>Агрегаты на компрессорах Frascold — подбор и сборка под ваш объект</h1>
      <p>Подберём и изготовим холодильные агрегаты на компрессорах Frascold для холодильных камер, складов, пищевых производств и промышленного холода. Учитываем температурный режим, хладагент, условия установки и требования к автоматике. Возможна поставка как отдельного агрегата, так и решения «под ключ».</p>
      <button class="btn" id="openCalcModal">Подобрать агрегат Frascold и рассчитать стоимость</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решают агрегаты на компрессорах Frascold?</h2>
      </div>
       <div class="problems-grid">
          ...
          <div class="problem-card">
            ...
            <p>Энергопотребление холодильного участка напрямую зависит от эффективности компрессорной части и корректного регулирования. Компоновка с Frascold и современной автоматикой помогает снизить расходы на частичных нагрузках.</p>
          </div>
          <div class="problem-card">
             <div class="problem-icon">
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Преимущества агрегатов на компрессорах Frascold</h2>
      </div>
      <p class="section-intro">Агрегаты на базе Frascold подбираются под ваш режим (средне‑/низкотемпературный), тип хладагента и условия эксплуатации. Сборка включает расчёт, компоновку узлов, настройку автоматики и заводские испытания перед отгрузкой.</p>
      ...
      <div class="features-list">
         ...
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Надёжная компрессорная часть Frascold</h3>
...
<!-- Секция товаров
 <section class='products-section'>
    <div class="container">
       <div class="section-title">
          <h2>Подберите агрегат на компрессоре Frascold</h2>
        </div>
       ...
       <div class="products-grid">
          <?php
         // Укажи slug категории WooCommerce для агрегатов Frascold
         $category_slug = 'frascold-compressor-units';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Агрегаты на компрессорах Frascold — особенности выбора и эксплуатации</h2>
         ...
         <p>Агрегаты на компрессорах Frascold подходят для средне‑ и низкотемпературных режимов. Компоновка может включать узлы обвязки, автоматику и защиты, а также опции под условия эксплуатации — например, зимний комплект или шумозащиту.</p>
         ...
         <p>Заказывая агрегаты Frascold у производителя «ТермоСервис», вы получаете инженерный подбор под вашу задачу, сборку и испытания, гарантию 2 года, а также услуги по монтажу и сервису. Это помогает снизить риски простоев и оптимизировать энергопотребление.</p>
      </div>
   </div>
</section>
...
<section class="final-cta">
   <div class="container">
      <h2>Нужно подобрать агрегат Frascold под вашу задачу?</h2>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчёт стоимости агрегата на компрессоре Frascold</h3>
      <div class="modal-product-info">
         <h4>Страница: Агрегаты на компрессорах Frascold</h4>
      ...
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет агрегата Frascold">
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: агрегат Frascold">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: агрегат Frascold">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: агрегат Frascold">
         <div class="form-group">
