 ...
 *
 * Шаблон страницы "Низкотемпературные агрегаты" (подкатегория "Холодильные агрегаты").
 *
 * @package Termoservis
 */
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <span>Низкотемпературные агрегаты</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Низкотемпературные агрегаты — надежный холод для заморозки и хранения</h1>
      <p>Раздел категории «Холодильные агрегаты». Низкотемпературные агрегаты применяются для камер заморозки и хранения при отрицательных температурах. Типовой диапазон — от <strong>-10°C до -30°C</strong> (часто -18°C / -25°C). Подбираем агрегат под продукт, объём, теплопритоки и режим оттайки, учитываем условия монтажа и требования к надежности 24/7.</p>
      <div class="cta-buttons">
         <button class="btn" id="openCalcModal">Рассчитать низкотемпературный агрегат</button>
         <?php if ( $medium_temp_page_url ) : ?>
            <a class="btn btn-outline" href="<?php echo esc_url( $medium_temp_page_url ); ?>">Среднетемпературные агрегаты</a>
         <?php endif; ?>
      </div>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решают низкотемпературные агрегаты?</h2>
      </div>
       <div class="problems-grid">
           <div class="problem-card">
             ...
             <h3>Стабильная заморозка и хранение</h3>
             <p>Поддерживаем уставку -18°C/-25°C без «просадок» и перегрузок. Правильный подбор по режиму обеспечивает устойчивую работу камеры и качество продукта.</p>
           </div>
           <div class="problem-card">
             <div class="problem-icon">
               <i class="fas fa-icicles"></i>
             </div>
             <h3>Наледь, оттайка и «задушенный» воздухообмен</h3>
             <p>На низких температурах критична оттайка: неправильные настройки дают наледь, падение производительности и рост энергопотребления. Подбираем и настраиваем режимы оттайки под задачу.</p>
           </div>
           <div class="problem-card">
              <div class="problem-icon">
                 <i class="fas fa-shield-alt"></i>
              </div>
             <h3>Аварии и остановки из‑за перегрузок</h3>
             <p>Для низких температур важны корректные уставки, защита компрессора, стабильная конденсация и возврат масла. Мы продумываем схему и защиты, чтобы избежать простоев.</p>
           </div>
           <div class="problem-card">
              <div class="problem-icon">
                 <i class="fas fa-bolt"></i>
              </div>
             <h3>Высокие расходы на электроэнергию</h3>
             <p>Низкотемпературный режим требовательнее к эффективности и настройкам. Оптимизация конденсации, правильный запас мощности и корректная оттайка помогают снизить потребление.</p>
           </div>
       </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Преимущества низкотемпературных агрегатов</h2>
      </div>
      <p class="section-intro">Подбираем агрегаты под отрицательные температуры (-10…-30°C): расчёт теплопритоков, подбор компрессорной части, автоматики и защит, настройка оттайки и заводские испытания перед отгрузкой.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Подбор под режим -18°C/-25°C</h3>
               <p>Учитываем продукт, объём, теплопритоки, оттайку, условия монтажа и сезонность, чтобы обеспечить стабильную температуру и избежать «коротких циклов».</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Компоновка и опции под объект</h3>
               <p>Продумываем размещение, сервисный доступ, защиту от обмерзания, «зимний комплект» и шумозащиту. Возможны решения с резервированием под критичные объекты.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Автоматика и защиты для низких температур</h3>
               <p>Защиты по давлению/температуре, контроль аварий, управление вентиляторами и клапанами, режимы оттайки. При необходимости — мониторинг и интеграция.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Энергоэффективность и устойчивость режима</h3>
               <p>Оптимизация конденсации и корректная оттайка дают экономию энергии и стабильную работу. Мы настраиваем режимы под вашу камеру и график эксплуатации.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Для морозильных камер важен контроль аварий и журналирование параметров. Реализуем сигнализацию и удалённый доступ для эксплуатации и диагностики.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Типовые режимы низкотемпературного хранения</h2>
      </div>
      <p class="section-intro">Ниже — ориентиры по диапазонам температур. Точный режим зависит от продукта, упаковки, логистики и требований к технологии.</p>
      ...
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Хранение заморозки</h3>
            <p>Часто -18°C. Базовый режим для большинства замороженных продуктов и полуфабрикатов.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-boxes-stacked"></i>
            </div>
            <h3>Склад глубокой заморозки</h3>
            <p>Обычно -25°C. Требовательнее к утеплению, дверям и режимам оттайки, чтобы не терять производительность.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-ice-cream"></i>
            </div>
            <h3>Мороженое и жиросодержащие продукты</h3>
            <p>Часто -25…-30°C. Нужны стабильная температура и корректная циркуляция воздуха по объёму камеры.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-truck-fast"></i>
            </div>
            <h3>Шоковая заморозка (опционально)</h3>
            <p>Обычно -30…-40°C. Подбираем решение под интенсивные нагрузки и требования к скорости заморозки.</p>
         </div>
      </div>
   </div>
</section>
...
<!-- Секция товаров
 <section class='products-section'>
    <div class="container">
       <div class="section-title">
           <h2>Подберите низкотемпературный агрегат</h2>
         </div>
       <p class="section-intro">Подбор по режиму -10…-30°C и параметрам объекта: различная холодопроизводительность, варианты автоматики и исполнения.</p>

       <div class="products-grid">
          <?php
         // Укажи slug категории WooCommerce для низкотемпературных агрегатов
         $category_slug = 'low-temperature-units';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Низкотемпературные агрегаты — особенности выбора и эксплуатации</h2>

         <p>Низкотемпературные агрегаты предназначены для морозильных камер и камер заморозки с режимами обычно от -10°C до -30°C. Наиболее распространённые уставки — -18°C и -25°C. Важно обеспечить стабильную температуру, корректную оттайку и надежную работу в режиме 24/7.</p>

         <p>При подборе учитывают теплопритоки, частоту открытий, тип испарителей, режимы оттайки, расчетные температуры кипения/конденсации, а также условия монтажа и сезонность. Низкотемпературный режим предъявляет повышенные требования к защите компрессора и стабильности конденсации.</p>

         <p>Энергоэффективность обеспечивается точным подбором, настройкой автоматики и оптимизацией конденсации. Важны правильные уставки и логика оттайки: наледь увеличивает сопротивление воздуху и резко снижает эффективность охлаждения.</p>

         <p>Эксплуатация включает регулярную очистку конденсатора, контроль масла и давления, обслуживание фильтров и датчиков, а также проверку оттайки и вентиляторов. Для морозильных складов полезны удалённый мониторинг и сигнализация аварий.</p>

         <p>Заказывая низкотемпературный агрегат у производителя «ТермоСервис», вы получаете инженерный расчёт, подбор комплектации, сборку и испытания, гарантию 2 года, а также услуги по монтажу и сервису. Это снижает риски простоев и помогает стабильно держать режим заморозки.</p>
      </div>
   </div>
</section>
...
<section class="final-cta">
   <div class="container">
      <h2>Нужно подобрать низкотемпературный агрегат?</h2>
      <p>Оставьте заявку — подготовим расчёт и коммерческое предложение под ваш режим заморозки и объект.</p>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчёт стоимости низкотемпературного агрегата</h3>
      <div class="modal-product-info">
         <h4>Страница: Низкотемпературные агрегаты</h4>
         <p>Подготовим предложение с учётом уставки (-18/-25), продукта, оттайки, условий установки и требований к автоматике.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет низкотемпературного агрегата">
         <input type="hidden" name="unitType" value="lt">
         ...
         <div class="form-group">
            ...
            <input type="text" id="calcTemperature" name="temperature" class="form-control" placeholder="Например: -18…-25">
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="text" id="calcProduct" name="product" class="form-control" placeholder="Например: мясо, рыба, мороженое, полуфабрикаты">
         </div>
         <div class="form-group">
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: низкотемпературный агрегат">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: низкотемпературный агрегат">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: низкотемпературные агрегаты">
         <div class="form-group">
