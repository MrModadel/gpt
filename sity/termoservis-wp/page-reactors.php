...
<section class="hero">
   <div class="container">
      <h1>Чиллеры для реакторов с точным контролем температуры</h1>
      <p>Промышленные чиллеры для реакторов обеспечивают отвод тепла из рубашки/змеевика и поддержание заданной температуры в химических и фармацевтических процессах. Это повышает выход продукта, снижает риски перегрева и помогает держать качество партии. Подберём решение под ваш объем, теплоноситель и температурный режим.</p>
      <button class="btn" id="openCalcModal">Рассчитать стоимость чиллера для вашего реактора</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие проблемы решает чиллер для реакторов?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Перегрев реакционной массы</h3>
            <p>В экзотермических реакциях избыток тепла приводит к срыву режима, росту давления и риску аварийной остановки. Стабильное охлаждение повышает безопасность и управляемость процесса.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-chart-line"></i>
            </div>
            <h3>Нестабильная температура процесса</h3>
            <p>Колебания температуры меняют скорость реакции и вязкость, ухудшают качество, выход и повторяемость партии. Чиллер держит уставку даже при переменной тепловой нагрузке.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-sync-alt"></i>
            </div>
            <h3>Длительное охлаждение и простои</h3>
            <p>Без достаточной холодопроизводительности увеличивается время набора/сброса температуры, снижается производительность и растут энергозатраты на цикл.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-tint"></i>
            </div>
            <h3>Агрессивные среды и отложения</h3>
            <p>Примеси и загрязнения снижают теплообмен и ускоряют износ оборудования. Закрытый контур с фильтрацией и правильно подобранными материалами защищает теплообменник и контур охлаждения.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Особенности чиллеров серии TS-REACT для реакторов</h2>
      </div>
      <p class="section-intro">Чиллеры нашего производства рассчитаны на отвод тепла от реакторов с рубашкой или змеевиком, а также от конденсаторов и теплообменников. Подходят для круглосуточной эксплуатации на производстве и работы с различными теплоносителями.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               ...
               <p>Поддерживает заданный режим реакции, улучшает качество продукта и повторяемость партии.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Подбираем насосную группу под рубашку/змеевик и гидравлику контура, чтобы обеспечить необходимый расход и не допускать перегрева.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Защита контура и подбор материалов</h3>
               <p>Фильтрация, датчики протока и защиты по давлению помогают предотвращать засоры и перегрев, а материалы теплообменника подбираются под условия эксплуатации.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Энергоэффективность на частичных нагрузках</h3>
               <p>Инверторная автоматика и корректный подбор мощности снижают энергопотребление при смене форм и колебаниях тепловой нагрузки.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
         ...
         <div class="feature-item">
            ...
            <div class="feature-text">
               ...
               <p>Проектирование контура, обвязка, монтаж, пусконаладка и обучение персонала для стабильной работы реакторного участка.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите чиллер для ваших реакторов</h2>
      </div>
      <p class="section-intro">Мы предлагаем решения для разных производств: от одного реактора до площадки с несколькими аппаратами и независимыми контурами.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для реакторов
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Промышленные чиллеры для реакторов — особенности выбора и эксплуатации</h2>

         <p>В химических и фармацевтических производствах реакторы работают в строго заданном температурном режиме. При экзотермических реакциях избыток тепла может привести к ускорению реакции, росту давления и ухудшению качества продукта. Поэтому стабильное охлаждение — ключ к безопасности и повторяемости партии.</p>

         <p>Чиллер обеспечивает замкнутую циркуляцию теплоносителя (вода/гликоль) через рубашку или змеевик реактора, теплообменник и при необходимости — конденсатор. Закрытый контур даёт стабильный расход и температуру, снижает расход воды и помогает защищать оборудование от загрязнений.</p>

         <p>При выборе чиллера учитывают тепловую нагрузку (кВт), объем аппарата, диапазон температур, тип теплообменной поверхности, расход и давление в контуре, а также свойства теплоносителя и требования к материалам. Для производства важны надежность 24/7, резервирование и интеграция в АСУ ТП.</p>

         <p>Эксплуатация требует обслуживания контура (фильтры, контроль качества теплоносителя), чистки конденсатора, контроля протока/давления и аварийных защит. Современные чиллеры поддерживают удаленный мониторинг, журнал ошибок и работу в широком диапазоне температур окружающей среды.</p>

         <p>Заказывая чиллер для реакторов у производителя «ТермоСервис», вы получаете инженерный расчет под конкретный процесс, подбор насосной группы и автоматики, заводские испытания, гарантию 2 года и услуги по монтажу и сервису. Это помогает стабилизировать режим и снизить риски перегрева.</p>
      </div>
   </div>
</section>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости чиллера для реакторов</h3>
      <div class="modal-product-info">
         <h4>Страница: Чиллеры для реакторов</h4>
         <p>Подготовим индивидуальное предложение с учётом объема, теплоносителя, диапазона температур и режима работы.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет чиллера для реакторов">
         ...
         <div class="form-group">
            <label for="calcReactorType">Схема охлаждения</label>
            <select id="calcReactorType" name="reactorType" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="jacket">Реактор с рубашкой</option>
               <option value="coil">Реактор со змеевиком</option>
               <option value="heat-exchanger">Через теплообменник</option>
               <option value="multiple">Несколько реакторов</option>
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Объем реактора, среда/теплоноситель, целевая температура, тепловыделение (если известно), количество аппаратов и контуров..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: чиллер для реакторов">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: чиллер для реакторов">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: чиллер для реакторов">
         <div class="form-group">
