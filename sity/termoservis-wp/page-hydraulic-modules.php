...
/**
 * Template Name: Гидромодули (гидрокофуль)
 *
 * Полный адаптированный шаблон страницы "Гидромодули (гидрокофуль)".
 *
 * @package Termoservis
 */
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <span>Гидромодули (гидрокофуль)</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Гидромодули (гидрокофуль) для чиллеров и систем охлаждения</h1>
      <p>Гидромодуль (гидрокофуль) обеспечивает стабильную циркуляцию теплоносителя (вода/гликоль) между чиллером и потребителями: держит расход и давление, защищает насосы, упрощает обвязку и обслуживание. Подберём конфигурацию под ваш контур — расход/напор, количество контуров, резервирование, буфер/расширение и автоматика.</p>
      <button class="btn" id="openCalcModal">Рассчитать стоимость гидромодуля</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решает гидромодуль (гидрокофуль)?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Нестабильный расход и давление</h3>
            <p>Недобор расхода снижает эффективность теплообмена и приводит к перегреву оборудования или аварийным остановкам. Правильно подобранная насосная группа стабилизирует параметры контура.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-exclamation-triangle"></i>
            </div>
            <h3>Кавитация, шум и износ насосов</h3>
            <p>Неправильный подбор насоса, недостаток подпора и воздух в системе приводят к кавитации и отказам. Гидромодуль с корректной гидравликой и защитами увеличивает ресурс.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-filter"></i>
            </div>
            <h3>Загрязнения и засоры в контуре</h3>
            <p>Окалина, ржавчина и накипь забивают арматуру и теплообменники. Фильтрация и контроль протока/давления защищают систему и уменьшают простои.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-project-diagram"></i>
            </div>
            <h3>Сложная обвязка и ошибки монтажа</h3>
            <p>Сборка на месте часто приводит к протечкам, неправильной арматуре и отсутствию сервисного доступа. Заводской гидромодуль поставляется готовым узлом — быстрее монтаж и запуск.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Особенности гидромодулей (гидрокофуль) ТермоСервис</h2>
      </div>
      <p class="section-intro">Гидромодули нашего производства обеспечивают циркуляцию воды/гликоля в контуре чиллера и потребителей, стабилизируют расход и давление, а также упрощают монтаж и обслуживание. Доступны исполнения с буферным/расширительным баком, фильтрацией, резервированием насосов и автоматикой.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Подбор по расходу и напору</h3>
               <p>Рассчитываем гидравлику и подбираем насос(ы) под сопротивление магистрали, коллекторов и потребителей для стабильной работы контура.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Резервирование насосов (1+1)</h3>
               <p>Варианты с рабочим и резервным насосом, автоматическое переключение и равномерная наработка для надежной эксплуатации 24/7.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Фильтрация и защиты контура</h3>
               <p>Фильтры, датчики протока/давления и защиты по сухому ходу помогают предотвращать засоры, кавитацию и аварийные остановки.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Инверторное управление и экономия энергии</h3>
               <p>Плавный пуск и регулирование по давлению/расходу снижают энергопотребление и уменьшают гидроудары в системе.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Автоматика и интеграция</h3>
               <p>Управление насосами, аварийные сигналы и удаленный контроль: Modbus/Profibus/Ethernet, мониторинг давления и протока.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Проектирование, обвязка, монтаж, пусконаладка и обучение персонала для стабильной работы системы охлаждения.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите гидромодуль под ваш контур</h2>
      </div>
      <p class="section-intro">Мы предлагаем решения для разных задач: один/два насоса, резервирование, буфер/расширение, автоматика и исполнение под воду или гликоль.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для гидромодулей
         $category_slug = 'hydromod';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Гидромодули (гидрокофуль) для чиллеров — особенности выбора и эксплуатации</h2>

         <p>Гидромодуль (гидрокофуль) — это насосная группа, которая обеспечивает циркуляцию теплоносителя между чиллером и потребителями. От правильного подбора гидромодуля напрямую зависят расход, перепад давления и стабильность работы теплообменников, а значит — и устойчивость технологического режима.</p>

         <p>Типовой гидромодуль может включать один или два насоса, запорную и балансировочную арматуру, фильтр, датчики протока/давления, расширительный и/или буферный бак, а также шкаф управления. Заводская компоновка упрощает монтаж и уменьшает риск ошибок при обвязке.</p>

         <p>При подборе гидромодуля учитывают требуемый расход (м³/ч или л/мин), напор (бар или м), количество контуров и их сопротивление, тип теплоносителя (вода/гликоль) и температурный диапазон. Для непрерывного производства важны резервирование насосов, наличие защит и возможность интеграции в АСУ ТП.</p>

         <p>Эксплуатация включает регулярную проверку фильтров, контроль давления в расширительном баке, удаление воздуха из системы, контроль концентрации гликоля (если используется) и мониторинг параметров насоса. Автоматика гидромодуля помогает фиксировать аварии и предупреждать простои.</p>

         <p>Заказывая гидромодуль у производителя «ТермоСервис», вы получаете инженерный расчет под конкретную систему, подбор насосной группы и автоматики, заводские испытания, гарантию 2 года и услуги по монтажу и сервису. Это помогает быстро запустить контур и стабилизировать работу охлаждения.</p>
      </div>
   </div>
</section>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости гидромодуля (гидрокофуль)</h3>
      <div class="modal-product-info">
         <h4>Страница: Гидромодули (гидрокофуль)</h4>
         <p>Подготовим индивидуальное предложение с учётом расхода/напора, теплоносителя, количества контуров и режима работы.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет гидромодуля (гидрокофуль)">
         ...
         <div class="form-group">
            <label for="calcHydroConfig">Конфигурация гидромодуля</label>
            <select id="calcHydroConfig" name="hydroConfig" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="single-pump">Один насос (1 контур)</option>
               <option value="dual-pump">Два насоса (рабочий + резерв)</option>
               <option value="buffer">С буферным баком / развязкой контуров</option>
               <option value="multi">Несколько контуров / коллектор</option>
               <option value="unknown">Не знаю / нужен подбор</option>
            </select>
         </div>
         <div class="form-group">
            <label for="calcFlow">Расход и напор (если известны)</label>
            <input type="text" id="calcFlow" name="flowHead" class="form-control" placeholder="Пример: 6 м³/ч, 2.5 бар">
         </div>
         <div class="form-group">
            <label for="calcComments">Дополнительная информация</label>
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Потребители и схема, теплоноситель (вода/гликоль), температура, требуемый расход/напор, количество контуров, нужен ли буфер/расширение, особые требования..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: гидромодуль (гидрокофуль)">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: гидромодуль (гидрокофуль)">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: гидромодуль (гидрокофуль)">
         <div class="form-group">
