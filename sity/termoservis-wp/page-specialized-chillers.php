...
<style>
    ...
    * {
    ...
    /* ===== 1. ГЕРОЙ-СЕКЦИЯ ===== */
    .special-hero {
        background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('https://images.iimg.live/images/amazing-shot-8342.webp') center/cover no-repeat;
        color: white;
        padding: 100px 0;
        position: relative;
    }
    ...
    .option-card:hover {
        border-color: #0056b8;
        transform: translateY(-3px);
        box-shadow: 0 5px 15px rgba(0, 86, 184, 0.1);
    }
    ...
    .diagnostic-result {
        background: linear-gradient(135deg, #023a7d 0%, #003a66 100%);
        color: #fff;
        padding: 32px;
        border-radius: 14px;
        margin-top: 40px;
        display: none;
        box-shadow: 0 8px 30px rgba(2, 58, 125, 0.25);
    ...
    .diagnostic-result .btn-outline:hover {
    ...
    .chat-button {
        ...
        font-size: 1.5rem;
        cursor: pointer;
        box-shadow: 0 5px 20px rgba(0, 86, 184, 0.3);
        transition: all 0.3s;
    }
