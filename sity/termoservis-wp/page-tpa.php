...
/**
 * Template Name: Для ТПА (термопластавтоматов)
 *
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <span>Для ТПА (термопластавтоматов)</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Чиллеры для ТПА (термопластавтоматов) с точным контролем температуры</h1>
      <p>Промышленные чиллеры для термопластавтоматов стабилизируют температуру теплоносителя для охлаждения пресс-форм, гидростанции и узлов машины. Это снижает брак, ускоряет цикл литья и повышает повторяемость изделий. Подберём решение под ваш ТПА и пресс-формы.</p>
      <button class="btn" id="openCalcModal">Рассчитать стоимость чиллера для вашего ТПА</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие проблемы решает чиллер для ТПА?</h2>
      </div>
      <div class="problems-grid">
         ...
         <div class="problem-card">
            ...
            <h3>Перегрев гидростанции и масла</h3>
            <p>Высокая температура масла ухудшает стабильность работы ТПА, ускоряет износ уплотнений и повышает риск простоев из‑за аварийных остановок.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Особенности чиллеров серии TS-TPA для термопластавтоматов</h2>
      </div>
      <p class="section-intro">Чиллеры нашего производства рассчитаны на охлаждение пресс-форм, гидростанций и термостатов. Подходят для горизонтальных и вертикальных ТПА, многогнездных форм и круглосуточной эксплуатации в цеху.</p>
      ...
      <div class="features-list">
         ...
         <div class="feature-item">
            ...
            <div class="feature-text">
               ...
               <p>Проектирование контуров, коллекторы, обвязка, монтаж, пусконаладка и обучение персонала для стабильной работы линии литья.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите чиллер для вашего ТПА</h2>
      </div>
      <p class="section-intro">Мы предлагаем решения для малых, средних и крупных литьевых производств: от одного ТПА до цеха с несколькими пресс-формами.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для ТПА
         $category_slug = 'tpa';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Промышленные чиллеры для ТПА (термопластавтоматов) — особенности выбора и эксплуатации</h2>

         <p>В литье пластмасс под давлением температура пресс-формы и стабильность охлаждения напрямую влияют на внешний вид и геометрию изделия. Перегрев или колебания температуры приводят к короблению, усадке, «утяжинам», нестабильным размерам и росту процента брака.</p>

         <p>Чиллер для ТПА обеспечивает замкнутую циркуляцию воды/гликоля через контуры охлаждения пресс-форм, коллекторы, термостаты и при необходимости — маслоохладитель гидростанции. Закрытая система даёт стабильный расход и температуру теплоносителя, снижает расход воды и защищает оборудование от загрязнений.</p>

         <p>При выборе чиллера учитывают тепловую нагрузку (пресс-форма, изделие, гидравлика), требуемую стабильность температуры, расход и давление в контурах охлаждения, количество независимых линий, а также качество воды и требования к материалам теплообменника. Для литьевого цеха важны фильтрация, датчики протока и защита по давлению.</p>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости чиллера для ТПА</h3>
      <div class="modal-product-info">
         <h4>Страница: Чиллеры для ТПА (термопластавтоматов)</h4>
         <p>Подготовим индивидуальное предложение с учётом параметров ТПА, пресс-форм и режима работы.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет чиллера для ТПА">
         ...
         <div class="form-group">
            <label for="calcTpaType">Тип ТПА</label>
            <select id="calcTpaType" name="tpaType" class="form-control">
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Марка и модель ТПА, усилие смыкания, требования к температуре пресс-формы, количество контуров..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: чиллер для ТПА">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: чиллер для ТПА">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: чиллер для ТПА">
         <div class="form-group">
