...
/**
 * Template Name: Элементы системы управления
 *
 * Полный адаптированный шаблон страницы "Элементы системы управления".
 *
 * @package Termoservis
 */
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <a href="/komponenty-i-moduli-dlya-chillerov">Компоненты и модули для чиллеров</a>
      <i class="fas fa-chevron-right"></i>
      <span>Элементы системы управления</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Элементы системы управления для чиллеров и систем охлаждения</h1>
      <p>Подберём и поставим элементы автоматики для управления чиллером, насосами и вентиляторами: контроллеры, датчики, частотные преобразователи, силовую часть, интерфейсы связи и компоненты шкафов управления. Поможем с подбором по задаче, интеграцией в существующую систему и подготовкой коммерческого предложения.</p>
      <button class="btn" id="openCalcModal">Подобрать элементы управления</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решают элементы системы управления?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Нестабильная температура и режимы</h3>
            <p>Некорректное регулирование приводит к «плаванию» температуры и частым остановкам. Правильно подобранные контроллер и датчики обеспечивают точность и стабильность технологического режима.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-shield-alt"></i>
            </div>
            <h3>Отсутствие защит и диагностики</h3>
            <p>Защиты по давлению/температуре, протоку, перегрузке и аварийные алгоритмы предотвращают повреждения оборудования и помогают быстро найти причину неисправности.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-bolt"></i>
            </div>
            <h3>Высокое энергопотребление</h3>
            <p>Частотное регулирование насосов и вентиляторов, плавный пуск и оптимальные алгоритмы снижают потребление энергии и уменьшают пиковые нагрузки.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-network-wired"></i>
            </div>
            <h3>Нет интеграции и удаленного контроля</h3>
            <p>Подключение к SCADA/BMS и диспетчеризации (Modbus/Ethernet), журнал аварий и удаленный мониторинг помогают управлять объектом и сокращать простои.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Элементы системы управления ТермоСервис</h2>
      </div>
      <p class="section-intro">Подбираем элементы автоматики под вашу задачу: управление температурой и мощностью, защита оборудования, энергосбережение, диспетчеризация и модернизация существующих систем. Возможна поставка отдельными позициями или комплектом для шкафа управления.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Контроллеры и логика управления</h3>
               <p>Подбор контроллера, настройка алгоритмов, уставок и режимов, управление компрессорами, насосами, вентиляторами и клапанами.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Датчики и измерение параметров</h3>
               <p>Датчики температуры, давления, протока, уровня и прочие элементы измерения для точного контроля и стабильной работы системы.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Силовая часть и защиты</h3>
               <p>Автоматы, контакторы, реле, блоки питания, тепловые защиты и другие компоненты для надежной работы и безопасности оборудования.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Частотное регулирование</h3>
               <p>ЧРП для насосов и вентиляторов, плавный пуск, оптимизация режимов — меньше энергопотребление и мягче работа оборудования.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Связь и интеграция</h3>
               <p>Интеграция в SCADA/BMS, протоколы Modbus/Ethernet/RS-485, удаленный мониторинг, журнал событий и аварий.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Шкафы управления и модернизация</h3>
               <p>Подбор комплекта, сборка/маркировка, проверка и пусконаладка. Возможна модернизация существующих шкафов и замена контроллеров.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите элементы системы управления под вашу задачу</h2>
      </div>
      <p class="section-intro">Поставим отдельные компоненты или комплект автоматики для вашего оборудования: контроллеры, датчики, частотники, силовые компоненты и элементы шкафов управления.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для элементов системы управления
         $category_slug = 'control-components';
...
<section style="background-color: #f1f5f9;">
   <div class="container">
      ...
      <p class="section-intro">Мы обеспечиваем полный цикл работ по автоматике — от проектирования схем и комплектации до пусконаладки и сервисного сопровождения.</p>
      ...
      <div class="services-grid">
         <div class="service-card">
            ...
            <p>Аудит существующей автоматики, подбор контроллера/датчиков/ЧРП, разработка схемы подключения и спецификации компонентов.</p>
         </div>
         <div class="service-card">
            <div class="service-icon">
               <i class="fas fa-tools"></i>
            ...
            <h3>Пусконаладка</h3>
            <p>Монтаж и подключение, настройка уставок и режимов, проверка защит, интеграция по протоколам связи, обучение персонала.</p>
         </div>
         <div class="service-card">
            <div class="service-icon">
            ...
            <h3>Сервис</h3>
            <p>Гарантия 2 года, диагностика и поддержка, помощь с настройками/интеграцией, поставка запасных частей и компонентов.</p>
         </div>
      </div>
   </div>
</section>
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Элементы системы управления для чиллеров — особенности выбора и эксплуатации</h2>

         <p>Элементы системы управления определяют стабильность работы чиллера и связанных контуров: от точности поддержания температуры до защиты компрессоров, насосов и теплообменников. Ключевую роль играют контроллер, датчики и корректно настроенные алгоритмы управления.</p>

         <p>Типовой состав системы управления включает контроллер или PLC, датчики температуры/давления/протока, силовую часть (автоматы, контакторы, реле), частотные преобразователи для регулирования насосов/вентиляторов и средства отображения/настройки (панель оператора, HMI). Для удаленного контроля применяются интерфейсы связи (RS-485/Ethernet) и протоколы обмена.</p>

         <p>При подборе учитывают тип оборудования и исполнительных механизмов, напряжение питания, требования к точности датчиков, условия эксплуатации (температура/влажность, вибрации), необходимость резервирования и требования к протоколам связи (SCADA/BMS). Важно предусмотреть аварийные алгоритмы и корректную диагностику.</p>

         <p>Эксплуатация включает проверку корректности показаний датчиков, настройку уставок, анализ журнала аварий и периодический осмотр силовых элементов. Частотные преобразователи и контроллеры требуют корректной конфигурации, а интеграция по протоколам связи — согласованных параметров сети.</p>

         <p>Заказывая элементы системы управления у «ТермоСервис», вы получаете инженерный подбор под конкретную задачу, совместимость компонентов, возможность поставки комплектом (в том числе для шкафа управления), консультации по настройке и интеграции, гарантию 2 года и сервисное сопровождение.</p>
      </div>
   </div>
</section>
...
<section class="final-cta">
   <div class="container">
      ...
      <p>Свяжитесь с нашими инженерами для подбора элементов системы управления и подготовки коммерческого предложения.</p>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Подбор элементов системы управления</h3>
      <div class="modal-product-info">
         <h4>Страница: Элементы системы управления</h4>
         <p>Подготовим предложение с учетом типа оборудования, состава автоматики, требуемых защит и интеграции (SCADA/BMS).</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Подбор элементов системы управления">
         ...
         <div class="form-group">
            <label for="calcControlTask">Что требуется</label>
            <select id="calcControlTask" name="controlTask" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="controller">Контроллер / плата управления</option>
               <option value="sensors">Датчики (t/Р/проток/уровень)</option>
               <option value="vfd">Частотный преобразователь (насос/вентилятор)</option>
               <option value="power">Силовая часть и защита (автоматы, реле, контакторы)</option>
               <option value="cabinet">Шкаф управления / комплект автоматики</option>
               <option value="integration">Интеграция в SCADA/BMS (Modbus/Ethernet)</option>
               <option value="unknown">Не знаю / нужен подбор</option>
            </select>
         </div>
         <div class="form-group">
            <label for="calcEquipment">Оборудование / модель (если известно)</label>
            <input type="text" id="calcEquipment" name="equipment" class="form-control" placeholder="Пример: чиллер, насосная станция, модель контроллера/ЧРП">
         </div>
         <div class="form-group">
            <label for="calcComments">Дополнительная информация</label>
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Задача, режимы, требуемые защиты, тип датчиков, протокол связи (если нужен), фото/маркировка компонентов, сроки..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: элементы системы управления">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: элементы системы управления">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: элементы системы управления">
         <div class="form-group">
