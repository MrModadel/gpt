...
/**
 * Template Name: Чиллер с фрикулингом
 *
 * Шаблон страницы про чиллеры с фрикулингом (free cooling)
 * Содержит контент, описывающий преимущества и применение фрикулинга.
 *
 * @package Termoservis
 */
...
<div class="breadcrumbs">
   <div class="container">
      ...
      <i class="fas fa-chevron-right"></i>
      <span>Чиллер с фрикулингом</span>
   </div>
</div>
...
<section class="hero">
   <div class="container">
      <h1>Чиллер с фрикулингом — экономичное охлаждение на низких температурах</h1>
      <p>Фрикулинг (free cooling) позволяет снизить энергопотребление за счёт использования холодного наружного воздуха или воды для прямого охлаждения технологического контура. Особенно эффективен в холодный сезон и при больших постоянных тепловых нагрузках.</p>
      <button class="btn" id="openCalcModal">Рассчитать решение с фрикулингом</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решает чиллер с фрикулингом?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Высокие энергозатраты на компрессорное охлаждение</h3>
            <p>Традиционные чиллеры потребляют много электроэнергии при низких уличных температурах, что увеличивает эксплуатационные расходы. Фрикулинг снижает работу компрессора и экономит энергию.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-snowflake"></i>
            </div>
            <h3>Неэффективное использование доступного холода</h3>
            <p>Многие системы не используют холод наружного воздуха или воды даже при подходящих условиях — упускается шанс существенной экономии. Правильная схема фрикулинга решает эту проблему.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-water"></i>
            </div>
            <h3>Большой расход воды и ресурсозатраты</h3>
            <p>Водяные схемы и непродуманная регулировка приводят к избыточному расходу воды и повышенным затратам на химобслуживание. Фрикулинг позволяет снизить потребление воды и нагрузку на теплообменники.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-exchange-alt"></i>
            </div>
            <h3>Сложность бесшовного переключения режимов</h3>
            <p>Переход между фрикулингом и компрессорным охлаждением без грамотной автоматики может вызывать гидравлические и температурные всплески. Нужна корректная автоматика и буферизация.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Преимущества чиллеров с фрикулингом</h2>
      </div>
      <p class="section-intro">Фрикулинг-чиллеры комбинируют компрессорное и свободное охлаждение: это снижает энергозатраты, продлевает ресурс оборудования и уменьшает время работы компрессора в холодный период.</p>
      ...
      <div class="features-list">
         ...
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Максимальная экономия энергии</h3>
               <p>Автоматическое переключение на фрикулинг позволяет снизить время работы компрессора и существенно уменьшить счета за электроэнергию в холодный период.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Плавное гибридное управление</h3>
               <p>Интеллектуальная автоматика обеспечивает бесшовный переход между фрикулингом и компрессорным режимом, исключая гидравлические и температурные перепады.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Оптимизация расхода воды и теплообмена</h3>
               <p>Подбираем dry-cooler или теплообменник и буферные ёмкости для минимизации расхода воды и устойчивой работы при переменных нагрузках.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Надёжность и защита оборудования</h3>
               <p>Фильтрация, защита от замерзания, выбор коррозионностойких материалов и мониторинг предотвращают повреждения внешних охладителей.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Интеграция с системой управления</h3>
               <p>Поддержка Modbus/Profibus/Ethernet и удалённого мониторинга для учёта экономии и контроля режимов фрикулинга.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Инжиниринг, подбор оборудования, монтаж и пусконаладка фрикулинг-системы с обучением персонала и сервисной поддержкой.</p>
            </div>
         </div>
      </div>
   </div>
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Фрикулинг: принципы работы и преимущества внедрения</h2>

         <p>Фрикулинг позволяет использовать холод внешней среды для прямого или косвенного охлаждения технологического контура без работы компрессора. Это особенно выгодно в холодное время года и ночью, когда температура наружного воздуха или воды достаточно низкая.</p>

         <p>Схемы реализации включают прямой воздухоохладитель (dry cooler), а также косвенные схемы с буферным баком и теплообменником. Комбинация с компрессорным чиллером даёт гибкость и стабильность в любые климатические условия.</p>

         <p>Эффект экономии зависит от климатической зоны, профиля нагрузки и допустимых уставок температуры в процессе. При правильном проектировании фрикулинг может сократить годовое энергопотребление системы охлаждения на значительный процент.</p>

         <p>Мы выполняем инженерные расчёты фрикулинг-схем, подбираем теплообменники, насосы и автоматику переключения, проводим пусконаладочные работы и обучение персонала для безопасной и эффективной работы.</p>
...
<section class="final-cta">
   <div class="container">
      <h2>Готовы внедрить фрикулинг и снизить энергозатраты?</h2>
      <p>Свяжитесь с нашими инженерами для бесплатного расчета фрикулинг-схемы и подбора оборудования.</p>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости чиллера с фрикулингом</h3>
      <div class="modal-product-info">
         <h4>Страница: Чиллер с фрикулингом</h4>
         <p>Подготовим индивидуальное предложение с учётом режима фрикулинга, теплоносителя и требований производства.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет чиллера с фрикулингом">
         ...
         <div class="form-group">
            <label for="calcReactorType">Схема фрикулинга</label>
            <select id="calcReactorType" name="reactorType" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="direct">Прямой (dry cooler / воздухоохладитель)</option>
               <option value="indirect">Косвенный (через бак-буфер и теплообменник)</option>
               <option value="hybrid">Комбинированный (байпас компрессора)</option>
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Параметры системы: объём, теплоноситель, целевая температура, тепловая нагрузка, особые требования..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: чиллер с фрикулингом">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: чиллер с фрикулингом">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: чиллер с фрикулингом">
         <div class="form-group">
