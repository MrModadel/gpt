...
/**
 * Template Name: Для пищевой промышленности
 *
...
<section class="hero">
   <div class="container">
      <h1>Чиллеры для пищевой промышленности: молоко, напитки, масло</h1>
      <p>Промышленные чиллеры обеспечивают стабильное охлаждение воды/гликоля для пастеризаторов, теплообменников, танков и линий розлива. Точный температурный режим помогает сохранять качество продукта и снижает риски срывов технологии. Подберём решение под вашу производительность, температурный график и санитарные требования.</p>
      <button class="btn" id="openCalcModal">Рассчитать стоимость чиллера для пищевого производства</button>
   </div>
</section>
...
<section>
   <div class="container">
      <div class="section-title">
         <h2>Какие задачи решает чиллер в пищевом производстве?</h2>
      </div>
      <div class="problems-grid">
         <div class="problem-card">
            ...
            <h3>Нестабильная температура продукта</h3>
            <p>Колебания температуры влияют на вкус, вязкость и стабильность качества (молоко, напитки, масло). Чиллер поддерживает уставку и обеспечивает повторяемость партии.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-chart-line"></i>
            </div>
            <h3>Риски порчи и сокращение срока хранения</h3>
            <p>Недостаточное или медленное охлаждение после пастеризации и в технологических ёмкостях повышает микробиологические риски. Стабильный холод помогает выдерживать санитарные нормы и режимы хранения.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-sync-alt"></i>
            </div>
            <h3>Простои и падение производительности</h3>
            <p>Если холодопроизводительности не хватает, увеличивается время выхода на режим и охлаждения, снижается производительность линии и растут потери на переработке.</p>
         </div>
         <div class="problem-card">
            <div class="problem-icon">
               <i class="fas fa-tint"></i>
            </div>
            <h3>Высокий расход воды и загрязнение контуров</h3>
            <p>Прямоточное охлаждение расходует много воды и приводит к накипи/загрязнениям теплообменников. Закрытый контур с фильтрацией стабилизирует параметры и снижает эксплуатационные расходы.</p>
         </div>
      </div>
   </div>
</section>
...
<section style="background-color: #f8f9fa;">
   <div class="container">
      <div class="section-title">
         <h2>Особенности чиллеров для пищевой промышленности</h2>
      </div>
      <p class="section-intro">Решения «ТермоСервис» подходят для молочных производств, напитков и масложировых линий: охлаждение после пастеризации, поддержание температуры в ёмкостях, охлаждение теплообменников и технологической воды/гликоля. Подбираем конфигурацию под санитарные требования и режим 24/7.</p>
      ...
      <div class="features-list">
         <div class="feature-item">
            ...
            <div class="feature-text">
               <h3>Точная стабилизация температуры (до ±0.5°C)</h3>
               <p>Стабильная уставка для пастеризации/охлаждения и технологических ёмкостей — меньше брака и выше повторяемость качества.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Стабильный расход и давление</h3>
               <p>Подбираем насосную группу под теплообменники, танки, линии розлива и проточные охладители, чтобы обеспечить нужный расход.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Чистота и защита контура</h3>
               <p>Фильтрация, датчики протока и аварийные защиты помогают предотвращать засоры, накипь и перегрев; по требованию — исполнение и материалы для пищевых производств.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               <h3>Энергоэффективность и экономия ресурсов</h3>
               <p>Инверторная автоматика и корректный подбор мощности снижают энергопотребление при переменных нагрузках; закрытый контур уменьшает расход воды.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Возможность удаленного контроля и управления: Modbus/Profibus/Ethernet, аварийные сигналы, контроль температуры и давления.</p>
            </div>
         </div>
         <div class="feature-item">
            <div class="feature-icon">
            ...
            <div class="feature-text">
               ...
               <p>Проектирование контура, обвязка, монтаж, пусконаладка и обучение персонала для стабильной работы пищевого участка.</p>
            </div>
         </div>
      </div>
...
<section class='products-section'>
   <div class="container">
      <div class="section-title">
         <h2>Подберите чиллер для пищевого производства</h2>
      </div>
      <p class="section-intro">Подберём решение под ваш процесс: молоко, напитки, масло — от одного агрегата до централизованной станции с несколькими контурами.</p>

      <div class="products-grid">
         <?php
         // Укажи slug категории WooCommerce для пищевой промышленности
         $category_slug = 'food-industry';
...
<section class="seo-section">
   <div class="container">
      <div class="seo-content">
         <h2>Промышленные чиллеры для пищевой промышленности — особенности выбора и эксплуатации</h2>

         <p>В пищевой промышленности (молоко, напитки, масло) стабильный температурный режим — ключ к качеству и безопасности продукта. Чиллеры применяются для охлаждения после пастеризации, поддержания температуры в танках и ёмкостях, а также для охлаждения теплообменников и линий розлива.</p>

         <p>Принцип работы промышленного чиллера основан на замкнутой циркуляции охлаждённой воды или водно‑гликолевой смеси. Закрытый контур даёт стабильный расход и температуру теплоносителя, снижает расход воды, уменьшает накипь и упрощает обслуживание оборудования.</p>

         <p>При выборе чиллера учитывают холодопроизводительность (кВт), температурный график, требуемые расход и давление, тип теплообменников и условия цеха. Для пищевых производств также важны требования к гигиене, защита от замерзания, резервирование и интеграция в АСУ ТП.</p>

         <p>Эксплуатация требует обслуживания контура (фильтры, контроль качества теплоносителя), чистки конденсатора, контроля протока/давления и аварийных защит. Современные чиллеры поддерживают удалённый мониторинг, журнал ошибок и работу при переменных нагрузках технологического цикла.</p>

         <p>Заказывая чиллер для пищевой промышленности у производителя «ТермоСервис», вы получаете инженерный расчет под конкретный продукт и оборудование, подбор насосной группы и автоматики, заводские испытания, гарантию 2 года и услуги по монтажу и сервису. Это помогает стабилизировать режим и снизить риски срывов технологии.</p>
      </div>
   </div>
</section>
...
<div class="modal-overlay" id="calcModal">
   <div class="modal">
      ...
      <h3>Расчет стоимости чиллера для пищевой промышленности</h3>
      <div class="modal-product-info">
         <h4>Страница: Для пищевой промышленности</h4>
         <p>Подготовим индивидуальное предложение с учётом производительности, температурного графика, теплоносителя и санитарных требований.</p>
      </div>
      <form id="calcForm" class="form-tel">
         <input type="hidden" name="formType" value="Расчет чиллера для пищевой промышленности">
         ...
         <div class="form-group">
            <label for="calcFoodProcess">Процесс / оборудование</label>
            <select id="calcFoodProcess" name="foodProcess" class="form-control">
               <option value="">Выберите вариант</option>
               <option value="milk">Молоко (танки/охладители)</option>
               <option value="beverages">Напитки (теплообменники/линия)</option>
               <option value="butter">Масло/сливки (ёмкости/охлаждение)</option>
               <option value="pasteurization">Охлаждение после пастеризации</option>
               <option value="fermentation">Ферментация/созревание</option>
         ...
         <div class="form-group">
            ...
            <textarea id="calcComments" name="message" class="form-control" rows="3" placeholder="Продукт, производительность (л/ч), температура вход/выход, режим работы, теплоноситель (вода/гликоль), особенности цеха и требования по гигиене..."></textarea>
         </div>
...
<div class="modal-overlay" id="quickOrderModal">
   <div class="modal">
      ...
      <form id="quickOrderForm" class="form-tel">
         <input type="hidden" name="formType" value="Быстрый заказ: чиллер для пищевой промышленности">
...
<div class="modal-overlay" id="proposalModal">
   <div class="modal">
      ...
      <form id="proposalForm" class="form-tel">
         <input type="hidden" name="formType" value="Коммерческое предложение: чиллер для пищевой промышленности">
         <div class="form-group">
...
<div class="modal-overlay" id="callbackModal">
   <div class="modal">
      ...
      <form id="callbackForm" class="form-tel">
         <input type="hidden" name="formType" value="Заказать звонок инженера: чиллер для пищевой промышленности">
         <div class="form-group">
